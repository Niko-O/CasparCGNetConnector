...
Public Class MixerClipCommand
    ...
    Private Sub InitParameter()
        ...
        addCommandParameter(New CommandParameter(Of Single)("x", " The left edge of the new clipSize, 0 = left edge of monitor, 0.5 = middle of monitor, 1.0 = right edge of monitor. Higher and lower values allowed. ", 0, True))
        addCommandParameter(New CommandParameter(Of Single)("y", "The top edge of the new clipSize, 0 = top edge of monitor, 0.5 = middle of monitor, 1.0 = bottom edge of monitor. Higher and lower values allowed.", 0, True))
        addCommandParameter(New CommandParameter(Of Single)("xscale", "The size of the new clipSize, 1 = 1x the screen size, 0.5 = half the screen size. Higher and lower values allowed. ", 1, True))
        addCommandParameter(New CommandParameter(Of Single)("yscale", "The size of the new clipSize, 1 = 1x the screen size, 0.5 = half the screen size. Higher and lower values allowed. ", 1, True))
    ...
    Public Overrides Function getCommandString() As String
        checkParameter()
        Dim cmd As String = "MIXER " & getDestination() & " CLIP"
